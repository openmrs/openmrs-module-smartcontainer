...
public class SamrtDataHandlerUtil {
	...
	public static ValueRange rangeHelper(Double high, Double low, String unit) {
		...
		if (high != null)
			range.setMaximum(SamrtDataHandlerUtil
					.valueAndUnitHelper(high, unit));
		if (low != null)
			range.setMinimum(SamrtDataHandlerUtil.valueAndUnitHelper(low, unit));
		return range;
	}
	...
	public static VitalSign vitalSignHelper(Double valueNumeric,
		...
		sign.setVitalName(SamrtDataHandlerUtil.codedValueHelper(cn, loincMap));
