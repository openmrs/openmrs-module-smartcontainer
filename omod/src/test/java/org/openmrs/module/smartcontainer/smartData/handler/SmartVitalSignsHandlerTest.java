...
public class SmartVitalSignsHandlerTest extends SmartDataHandlerTest {
	
	/**
	 * @see {@link SmartVitalSignsHandler#getAllForPatient(Patient)}
	 */
	@Test
	@Verifies(value = "should get all the patient vital signs", method = "getAllForPatient(Patient)")
