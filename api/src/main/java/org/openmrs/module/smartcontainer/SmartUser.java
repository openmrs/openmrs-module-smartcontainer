...
public class SmartUser {
	...
	/**
	 * a collection of smart apps that the user doesn't want to see on their patient dashboard
	 */
	private Collection<App> hiddenApps;
	...
	/**
	 * @return the hiddenApps
	 */
	public Collection<App> getHiddenApps() {
		if (hiddenApps == null)
			hiddenApps = new LinkedHashSet<App>();
		
		return hiddenApps;
	}
	
	/**
	 * @param hiddenApps the hiddenApps to set
	 */
	public void setHiddenApps(Collection<App> hiddenApps) {
	...
	/**
	 * @param sMARTAppUserId the sMARTAppUserId to set
	 */
	...
	/**
	 * @param openMRSUser the openMRSUser to set
	 */
